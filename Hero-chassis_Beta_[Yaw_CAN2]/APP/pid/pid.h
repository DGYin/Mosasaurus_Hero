...
#define aPID_OUT_MAX_CHASSIS          1300		//即最大速度
...
#define pid_init() \
				do{ \
					...
					chassis_center.pid.position_loop.pid_Parameter.Vkp = 1; \
					...
					Chassis_Motor2.pid.speed_loop.pid_Parameter.Vki = 0.1;   \
					Chassis_Motor3.pid.speed_loop.pid_Parameter.Vki = 0.1;   \
					Chassis_Motor4.pid.speed_loop.pid_Parameter.Vki = 0.1;   \
                    ...
                    \
                    Chassis_MotorA.pid.speed_loop.pid_Parameter.Vkp = 3.15;   \
					Chassis_MotorB.pid.speed_loop.pid_Parameter.Vkp = 3.15;   \
					Chassis_MotorC.pid.speed_loop.pid_Parameter.Vkp = 3.15;   \
					Chassis_MotorD.pid.speed_loop.pid_Parameter.Vkp = 3.15;   \
					Chassis_MotorA.pid.speed_loop.pid_Parameter.Vki = 0.2;   \
					Chassis_MotorB.pid.speed_loop.pid_Parameter.Vki = 0.2;   \
					Chassis_MotorC.pid.speed_loop.pid_Parameter.Vki = 0.2;   \
					Chassis_MotorD.pid.speed_loop.pid_Parameter.Vki = 0.2;   \
					Chassis_MotorA.pid.speed_loop.pid_Parameter.Vkd = 0.1;   \
					Chassis_MotorB.pid.speed_loop.pid_Parameter.Vkd = 0.1;   \
					Chassis_MotorC.pid.speed_loop.pid_Parameter.Vkd = 0.1;   \
					Chassis_MotorD.pid.speed_loop.pid_Parameter.Vkd = 0.1;   \
                    \
                    Chassis_MotorA.pid.position_loop.pid_Parameter.Akp = 0.7;   \
					Chassis_MotorB.pid.position_loop.pid_Parameter.Akp = 0.7;   \
					Chassis_MotorC.pid.position_loop.pid_Parameter.Akp = 0.7;   \
					Chassis_MotorD.pid.position_loop.pid_Parameter.Akp = 0.6;   \
					Chassis_MotorA.pid.position_loop.pid_Parameter.Aki = 0;   \
					Chassis_MotorB.pid.position_loop.pid_Parameter.Aki = 0;   \
					Chassis_MotorC.pid.position_loop.pid_Parameter.Aki = 0;   \
					Chassis_MotorD.pid.position_loop.pid_Parameter.Aki = 0;   \
                    ...
                    Chassis_MotorA.pid.position_loop.pid_Parameter.Vkp = 4.5;   \
					Chassis_MotorB.pid.position_loop.pid_Parameter.Vkp = 4.5;   \
					Chassis_MotorC.pid.position_loop.pid_Parameter.Vkp = 4.5;   \
					Chassis_MotorD.pid.position_loop.pid_Parameter.Vkp = 5;   \
					Chassis_MotorA.pid.position_loop.pid_Parameter.Vki = 0.6;   \
					Chassis_MotorB.pid.position_loop.pid_Parameter.Vki = 0.6;   \
					Chassis_MotorC.pid.position_loop.pid_Parameter.Vki = 0.6;   \
					Chassis_MotorD.pid.position_loop.pid_Parameter.Vki = 0.5;   \
					Chassis_MotorA.pid.position_loop.pid_Parameter.Vkd = 0.0;   \
