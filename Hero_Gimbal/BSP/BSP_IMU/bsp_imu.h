...
#define GIMBAL_GYRO_X_ZERO_CORRECT       0.05f  //0.3f                        //俯仰陀螺仪x轴方向死区修正(云台)
#define GIMBAL_GYRO_Y_ZERO_CORRECT       0.05f  //0.2f                        //俯仰陀螺仪y轴方向死区修正(云台)
#define GIMBAL_GYRO_Z_ZERO_CORRECT       0.02f  //0.2f                        //俯仰陀螺仪z轴方向死区修正(云台)
